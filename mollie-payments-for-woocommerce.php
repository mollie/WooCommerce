 ...
 * Version: 8.1.10+piwoo-908-type-error-in-mollie-order-service-when-payment-redirect-url-is-null-during-webhook-fallback.b5cb524
 * SHA: b5cb52471021911765628672583b32988241e858
 * Author: Mollie
...
register_activation_hook(__FILE__, static function (): void {
    ...
    \Mollie\WooCommerce\Tracks\TracksModule::onPluginActivation();
});
register_deactivation_hook(__FILE__, static function (): void {
    mollie_wc_plugin_autoload();
    \Mollie\WooCommerce\Tracks\TracksModule::onPluginDeactivation();
});
add_action(
    /**
     * @throws Throwable
