...
return static function (): array {
    return [
        ...
        StartExpressOrder::class => static function (ContainerInterface $container): StartExpressOrder {
            return new StartExpressOrder($container->get(CartFactsBuilder::class), $container->get(ExpressFactsBuilder::class), $container->get(ExpressOrderFactsBuilder::class), $container->get(ExpressSessionStore::class), $container->get(ExpressOrderFactory::class), $container->get(EffectInterpreter::class), $container->get(OrderLock::class), $container->get(Clock::class), $container->get(EventLog::class));
        },
        ...
        ExpireAbandonedExpressOrders::class => static function (ContainerInterface $container): ExpireAbandonedExpressOrders {
            return new ExpireAbandonedExpressOrders($container->get(ExpressOrderFactsBuilder::class), $container->get(MollieApi::class), $container->get(EffectInterpreter::class), $container->get(Clock::class), $container->get(EventLog::class), (int) $container->get('express.config')['abandonGraceSeconds']);
        },
        ...
        ResolveExpressPayment::class => static function (ContainerInterface $container): ResolveExpressPayment {
            return new ResolveExpressPayment($container->get(MollieApi::class), $container->get(ExpressOrderFactsBuilder::class), $container->get(EffectInterpreter::class), $container->get(EventLog::class), $container->get(OrphanedExpressPayments::class), $container->get('express.config')['wallets'], static function (): array {
