...
class Settings
{
     ...
     */
    public function __construct(string $pluginId, Status $statusHelper, string $pluginVersion, string $pluginUrl, Api $apiHelper, CleanDb $cleanDb)
    {
     ...
     * @return array<mixed>
     */
    public function generalFormFields(string $defaultTitle, string $defaultDescription, bool $paymentConfirmation): array
    {
    ...
    public function getPluginStatus()
    {
        ...
        try {
            ...
            $api_status = '' . '<p style="font-weight:bold;"><span style="color:red;">Communicating with Mollie failed:</span> ' . $e->getMessage() . '</p>' . '<p>Please view the FAQ item <a href="https://github.com/mollie/WooCommerce/wiki/Common-issues#communicating-with-mollie-failed" target="_blank">Communicating with Mollie failed</a> if this does not fix your problem.';
