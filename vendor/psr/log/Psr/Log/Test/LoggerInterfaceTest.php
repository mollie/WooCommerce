...
namespace Mollie\Psr\Log\Test;

use Mollie\Psr\Log\LoggerInterface;
use Mollie\Psr\Log\LogLevel;
use Mollie\PHPUnit\Framework\TestCase;
/**
...
abstract class LoggerInterfaceTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('Mollie\Psr\Log\LoggerInterface', $this->getLogger());
    }
    /**
    ...
    public function testObjectCastToString()
    {
        if (method_exists($this, 'createPartialMock')) {
            $dummy = $this->createPartialMock('Mollie\Psr\Log\Test\DummyTest', array('__toString'));
        } else {
            $dummy = $this->getMock('Mollie\Psr\Log\Test\DummyTest', array('__toString'));
        }
