...
final class CartLine
{
     ...
     */
    public function __construct(private int $productId, private int $quantity, private bool $isSubscription, private string $name = '', private ?\Mollie\WooCommerce\Core\Types\Money $subtotal = null, private string $vatRate = '0.00')
    {
    }
    ...
    public function subtotal(): ?\Mollie\WooCommerce\Core\Types\Money
    {
