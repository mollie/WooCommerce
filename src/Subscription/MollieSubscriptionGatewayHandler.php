...
class MollieSubscriptionGatewayHandler extends MolliePaymentGatewayHandler
{
     ...
     * @throws ApiException
     */
    protected function usePreviousMandate(int $renewal_order_id, string $customer_id, \Mollie\Api\MollieApiClient $mollieApiClient, string $mandateId, bool $isRenewalMethodDirectDebit, array $data, bool $validMandate, \WC_Payment_Gateway $gateway): array
    {
     ...
     * @throws ApiException
     */
    protected function useAnyValidMandate(int $renewal_order_id, string $customer_id, \Mollie\Api\MollieApiClient $mollieApiClient, bool $validMandate, array $data, string $renewalOrderMethod, \WC_Payment_Gateway $gateway): array
    {
