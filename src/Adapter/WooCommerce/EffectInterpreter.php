...
final class EffectInterpreter
{
    ...
    {
        return ['express.order.created' => __('Express checkout started', 'mollie-payments-for-woocommerce'), 'express.order.abandoned' => __('Express checkout was started and not completed', 'mollie-payments-for-woocommerce')];
    }
    /**
     * @param array<int, Effect> $effects
