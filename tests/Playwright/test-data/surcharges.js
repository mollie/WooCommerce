const {settingsNames} = require("../utils/mollieUtils");
//taxes 10% shipping 10€ price of product 10€
    ...
    'fixedFeeTest': {
        ...
        'payload': {
            "settings": {
                ...
                [settingsNames.maxLimit]: 0
            }
        },
        'productQuantity': 10,
        'totalExpectedAmount': 122.00,
        'methods': {
            'bancontact': 'C129503',
            //'applepay': 'C420310',
            'belfius': 'C138012',
    ...
    'percentageFeeTest': {
        ...
        'payload': {
            "settings": {
                ...
                [settingsNames.percentage]: '10.00',
                [settingsNames.limitFee]: '0.0',
                [settingsNames.maxLimit]: 0
            }
        },
        'productQuantity': 10,
        'totalExpectedAmount': 123.21,
        'methods': {
            'bancontact': 'C129504',
            //'applepay': 'C420311',
            'belfius': 'C138013',
    ...
    'fixedAndPercentageFeeTest': {
        ...
        'payload': {
            "settings": {
                ...
                [settingsNames.percentage]: '10.00',
                    [settingsNames.limitFee]: '0.0',
                [settingsNames.maxLimit]: '0.0'
            }
        },
        'productQuantity': 10,
        'totalExpectedAmount': 134.21,
        'methods': {
            'bancontact': 'C129505',
            //'applepay': 'C420312',
            'belfius': 'C138014',
