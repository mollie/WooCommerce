...
namespace Mollie\enshrined\svgSanitize\ElementReference;

use Mollie\enshrined\svgSanitize\data\XPath;
use Mollie\enshrined\svgSanitize\Exceptions\NestingException;
use Mollie\enshrined\svgSanitize\Helper;
class Resolver
{
    /**
     * @var XPath
