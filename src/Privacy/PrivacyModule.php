...
class PrivacyModule implements ExecutableModule
{
    ...
    public function registerPrivacyPolicyContent(): void
    {
        ...
        $content = '<div class="wp-suggested-text"><p>' . sprintf(__('By using this extension, you may be processing personal data with Mollie. Please see <a href="%s">here</a> for more information.', 'mollie-payments-for-woocommerce'), 'https://www.mollie.com/legal/privacy') . '</p></div>';
