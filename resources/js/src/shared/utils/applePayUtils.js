...
export const ApplePayUtils = {
	 ...
	 * @return {boolean} True if the item is an Apple Pay method, false otherwise
	 * @example
	 ...
	 * @return {boolean} True if ApplePaySession is available and can make payments, false otherwise
	 * @example
	 ...
	 * @return {boolean} True if Apple Pay can be registered, false otherwise
	 * @example
