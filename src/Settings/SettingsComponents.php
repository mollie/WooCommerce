...
class SettingsComponents
{
     ...
     * @var string[]
     */
    public const STYLE_KEY_PREFIXES = ['invalid_'];
    /**
     * @var string
     */
    ...
    public function styles()
    {
        ...
        $settings = [];
        $settings[StylesPropertiesDictionary::BASE_STYLE_KEY] = $this->optionsFor(StylesPropertiesDictionary::STYLES_OPTIONS_KEYS_MAP, $defaults);
        $settings[StylesPropertiesDictionary::INVALID_STYLE_KEY] = $this->optionsFor(StylesPropertiesDictionary::INVALID_STYLES_OPTIONS_KEYS_MAP, $defaults);
        return $settings;
    }
