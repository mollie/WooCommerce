...
namespace Mollie\enshrined\svgSanitize;

use Mollie\enshrined\svgSanitize\data\AllowedAttributes;
use Mollie\enshrined\svgSanitize\data\AllowedTags;
use Mollie\enshrined\svgSanitize\data\AttributeInterface;
use Mollie\enshrined\svgSanitize\data\TagInterface;
use Mollie\enshrined\svgSanitize\data\XPath;
use Mollie\enshrined\svgSanitize\ElementReference\Resolver;
/**
 * Class Sanitizer
 *
