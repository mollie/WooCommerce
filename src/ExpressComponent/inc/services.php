...
return static function (): array {
    return [
        ...
        ResolveExpressPayment::class => static function (ContainerInterface $container): ResolveExpressPayment {
            return new ResolveExpressPayment($container->get(MollieApi::class), $container->get(ExpressOrderFactsBuilder::class), $container->get(EffectInterpreter::class), $container->get(EventLog::class), $container->get('express.config')['wallets'], static function (): array {
