...
class ShortNumberInfo
{
    ...
    protected static $regionsWhereEmergencyNumbersMustBeExact = ['BR', 'CL', 'NI'];
    ...
    protected function matchesEmergencyNumberHelper($number, $regionCode, $allowPrefixMatch)
    {
        ...
        $allowPrefixMatchForRegion = $allowPrefixMatch && !in_array(strtoupper($regionCode), static::$regionsWhereEmergencyNumbersMustBeExact);
