...
class PaymentLinkPaymentEndpoint extends \Mollie\Api\Endpoints\CollectionEndpointAbstract
{
     ...
     */
    public function iteratorForId(string $paymentLinkId, ?string $from = null, ?int $limit = null, array $parameters = [], bool $iterateBackwards = \false): LazyCollection
    {
        $this->parentId = $paymentLinkId;
     ...
     * @return LazyCollection
     */
    public function iteratorFor(PaymentLink $paymentLink, ?string $from = null, ?int $limit = null, array $parameters = [], bool $iterateBackwards = \false): LazyCollection
    {
