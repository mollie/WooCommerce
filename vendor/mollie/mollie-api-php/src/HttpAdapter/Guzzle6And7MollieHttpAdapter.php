...
use Mollie\GuzzleHttp\Client;
use Mollie\GuzzleHttp\ClientInterface;
use Mollie\GuzzleHttp\Exception\GuzzleException;
use Mollie\GuzzleHttp\HandlerStack;
use Mollie\GuzzleHttp\Psr7\Request;
use Mollie\GuzzleHttp\RequestOptions as GuzzleRequestOptions;
use Mollie\Api\Exceptions\ApiException;
use Mollie\Psr\Http\Message\ResponseInterface;
final class Guzzle6And7MollieHttpAdapter implements \Mollie\Api\HttpAdapter\MollieHttpAdapterInterface
{
    ...
    public static function createDefault()
    {
        ...
        $client = new Client([GuzzleRequestOptions::VERIFY => CaBundle::getBundledCaBundlePath(), GuzzleRequestOptions::TIMEOUT => self::DEFAULT_TIMEOUT, GuzzleRequestOptions::CONNECT_TIMEOUT => self::DEFAULT_CONNECT_TIMEOUT, 'handler' => $handlerStack]);
    ...
    public function versionString()
    {
        ...
        } elseif (defined('Mollie\GuzzleHttp\ClientInterface::VERSION')) {
            // Before Guzzle 7
