...
class DataToAppleButtonScripts
{
     ...
     * @return array<mixed>
     */
    protected function dataForProductPage(string $shopCountryCode, string $currencyCode, string $totalLabel): array
    {
        ...
        return ['product' => ['needShipping' => $productNeedShipping, 'id' => $productId, 'price' => $productPrice, 'isVariation' => $isVariation, 'stock' => $productStock], 'shop' => ['countryCode' => $shopCountryCode, 'currencyCode' => $currencyCode, 'totalLabel' => $totalLabel], 'ajaxUrl' => admin_url('admin-ajax.php')];
    }
    /**
     * @param string $shopCountryCode
     * @param string $currencyCode
     ...
     * @return array<mixed>
     */
    protected function dataForCartPage(string $shopCountryCode, string $currencyCode, string $totalLabel): array
    {
        $cart = WC()->cart;
