...
use Mollie\libphonenumber\prefixmapper\PrefixTimeZonesMap;
class PhoneNumberToTimeZonesMapper
{
    ...
    {
        $this->prefixTimeZonesMap = static::loadPrefixTimeZonesMapFromFile(__DIR__ . $phonePrefixDataDirectory . \DIRECTORY_SEPARATOR . static::MAPPING_DATA_FILE_NAME);
