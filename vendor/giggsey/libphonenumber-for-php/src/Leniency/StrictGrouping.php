...
namespace Mollie\libphonenumber\Leniency;

use Mollie\libphonenumber\PhoneNumber;
use Mollie\libphonenumber\PhoneNumberMatcher;
...
class StrictGrouping extends AbstractLeniency
{
    ...
    public static function verify(PhoneNumber $number, $candidate, PhoneNumberUtil $util)
    {
        ...
        return PhoneNumberMatcher::checkNumberGroupingIsValid($number, $candidate, $util, function (PhoneNumberUtil $util, PhoneNumber $number, $normalizedCandidate, $expectedNumberGroups) {
