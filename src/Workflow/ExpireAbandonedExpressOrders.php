...
final class ExpireAbandonedExpressOrders
{
    ...
    public function __construct(private ExpressOrderFactsBuilder $orderFacts, private MollieApi $mollie, private EffectInterpreter $effects, private Clock $clock, private EventLog $log, private int $graceSeconds)
    {
    }
