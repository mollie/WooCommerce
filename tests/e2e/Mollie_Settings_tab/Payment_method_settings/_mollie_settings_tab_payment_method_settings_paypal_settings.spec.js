...
//TestId-C130886
test('Validate  PayPal  surcharge with no Fee, no fee will be added to total', async ({ page, products, context}) => {
...
//TestId-C130887
test('Validate fixed fee for  PayPal  surcharge', async ({ page, products, context}) => {
    const fee = 10;
...
//TestId-C130888
test('Validate percentage fee for PayPal  surcharge', async ({ page, products, context}) => {
    const fee = 10;
...
//TestId-C130889
test('Validate fixed fee and percentage for  PayPal  surcharge', async ({ page, products, context}) => {
    const fee = 10;
...
//TestId-C130891
test('Validate surcharge for PayPal   when is selected percentage for payment surcharge and Surcharge only under this limit in € is setup, surcharge will be added for total under limit', async ({ page, products, context}) => {
    const fee = 10;
    const limit = 30;
    await selectOptionSetting(page, context.surchargeSetting, context.tabUrl, 'percentage');
    const percentageFeeSetting = settingsNames.percentage(context.method.id);
...
//TestId-C130892
test('Validate surcharge for PayPal  when is selected fixed fee and percentage for payment surcharge and Surcharge only under this limit in € is setup, surcharge will be added for total under limit', async ({ page, products, context}) => {
    const fee = 10;
    const limit = 30;
    await selectOptionSetting(page, context.surchargeSetting, context.tabUrl, 'fixed_fee_percentage');
    const fixedFeeSetting = settingsNames.fixedFee(context.method.id);
...
//TestId-C130893
test('Validate PayPal surcharge for fixed fee if  surcharge limit in € is setup, gateway fee will not be added if surcharge exceeded limit', async ({ page, products, context}) => {
    const fee = 10;
    const limit = 30;
...
//TestId-C130894
test('Validate surcharge for  PayPal  when is selected percentage fee for payment surcharge and Surcharge only under this limit in € is setup, surcharge will no be added for price above limit', async ({ page, products, context}) => {
    const fee = 10;
    const limit = 30;
    const productQuantity = 2;
    await selectOptionSetting(page, context.surchargeSetting, context.tabUrl, 'percentage');
...
//TestId-C130895
test('Validate surcharge for  PayPal   when is selected fixed fee and percentage fee for payment surcharge and Surcharge only under this limit in € is setup, surcharge will no be added for price above limit', async ({ page, products, context}) => {
    const fee = 10;
    const limit = 30;
    const productQuantity = 2;
    await selectOptionSetting(page, context.surchargeSetting, context.tabUrl, 'fixed_fee_percentage');
