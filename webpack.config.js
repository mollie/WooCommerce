...
function configJavaScript ({ basePath })
{
  Encore
    ...
    .addEntry('rivertyCountryPlaceholder.min', './resources/js/rivertyCountryPlaceholder.js')
      ...
      .addEntry('mollie-return-page-monitor.min', './resources/js/mollie-return-page-monitor.js')
      .addEntry('return-page-monitor.min', './resources/js/return-page-monitor.js')
...
function configCss ({ basePath })
{
  Encore
    ...
    .addStyleEntry('mollie-block-custom-field.min', './resources/scss/mollie-block-custom-field.scss')
      .addStyleEntry('return-page-monitor.min', './resources/scss/return-page-monitor.css')
    .enableSourceMaps(!Encore.isProduction())
