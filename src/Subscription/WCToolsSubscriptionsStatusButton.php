...
class WCToolsSubscriptionsStatusButton
{
    ...
    function __construct()
    {
        ...
        add_filter('woocommerce_debug_tools', [ $this, 'mollie_subscription_status_check_button' ]);
    }
    ...
    function mollie_subscription_status_check_button($old)
    {
        ...
        $new =  [
            'mollie_subscription_status_check_action' =>  [
                ...
                'desc' => $description,
                'callback' =>  [ $this, 'mollie_subscription_status_check_action' ],
            ],
        ];
    ...
    function mollie_subscription_status_check_action()
    {
        ...
        $subscriptions = wcs_get_subscriptions([ 'subscriptions_per_page' => '10', 'offset' => $offset ]);
        ...
        foreach ($subscriptions as $subscription) {
            ...
            if (( $subscription_is_manual ) && ( $subscription_status == 'on-hold' )) {
                ...
                // Get all mandates for this MollieSettingsPage customer ID
                try {
                    $mandates = Plugin::getApiHelper()->getApiClient($test_mode)->customers->get($mollie_customer_id)->mandates();
        ...
        if (! empty($updated_subscriptions)) {
            ...
            Plugin::debug('Subscriptions updated by \'Check Mollie Subscriptions Status\': ' . implode(', ', $updated_subscriptions) . '. See https://github.com/mollie/WooCommerce/wiki/Mollie-Subscriptions-Status');
        } else {
            echo '<div class="updated"><p>';
        ...
        $subscriptions_left = wcs_get_subscriptions([
...
$GLOBALS['WC_Tools_Subscriptions_Status_Button'] = new WCToolsSubscriptionsStatusButton();
