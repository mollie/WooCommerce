...
class PaymentProcessor implements PaymentProcessorInterface
{
     ...
     * @return mixed
     */
    public function getProcessPaymentRedirect($paymentMethod, WC_Order $order, $paymentObject, string $redirectUrl)
    {
     ...
     * @throws ApiException
     */
    protected function processAsMolliePayment(\WC_Order $order, $customer_id, $apiKey): Payment
    {
     ...
     * @throws ApiException
     */
    protected function processPaymentForMollie($molliePaymentType, int $orderId, $paymentObject, \WC_Order $order, $customer_id, $apiKey)
    {
        //
     ...
     */
    public function updateOrderStatus(\WC_Order $order, $new_status, string $note = '', bool $restore_stock = \true): void
    {
